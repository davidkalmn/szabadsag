...
export default function AllLeaves({ leaves, user, filters = {}, users = [] }) {
    ...
    const handleFilterChange = (filterType, value) => {
        ...
        router.get(route('szabadsag.osszes-kerelem'), newFilters, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const clearFilters = () => {
        ...
        setCreatedFrom('');
        setCreatedTo('');
        router.get(route('szabadsag.osszes-kerelem'), {}, {
            preserveState: true,
            preserveScroll: true,
        });
    };
