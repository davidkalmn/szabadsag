...
export default function All({ events = [], user }) {
    const calendarEvents = useMemo(() => {
        if (!events || !Array.isArray(events) || events.length === 0) {
            console.log('Calendar All - No events found:', events);
            return [];
        }
        ...
        console.log('Calendar All - Formatted events:', formatted);
        console.log('Calendar All - Raw events:', events);
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Összes naptár" />
            <PageContainer>
                <div>
                    <div className="mb-6">
                        <h1 className="text-2xl font-bold text-gray-900">Összes naptár</h1>
                        <p className="mt-2 text-sm text-gray-600">
                            Az összes felhasználó szabadság kérelmei naptár nézetben
                        </p>
                    </div>
